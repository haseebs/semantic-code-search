...
class NbowEncoder(EncoderBase):
    def __init__(self, hyperparameters: Dict[str, Any]):
        ...
        self.embeddings = nn.Embedding(self.hypers["vocab_size"], self.hypers["embedding_dim"])
    ...
    def forward(self, seq_tokens, seq_tokens_mask, seq_len):
        ...
        seq_token_embeddings_masked = seq_token_embeddings * seq_tokens_mask.unsqueeze(dim=-1)

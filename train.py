...
def run():
    hypers = {'code_encoder_type': 'nbow_encoder',
    ...
    train_dataset = CSNDataset(hypers=hypers,
                               keep_keys=keep_keys,
                               data_split='train')
    valid_dataset = CSNDataset(hypers=hypers,
                               keep_keys=keep_keys,
                               data_split='valid')
    test_dataset = CSNDataset(hypers=hypers,
                               keep_keys=keep_keys,
                              data_split='test')


    model = ModelBase(hypers,
                      train_dataset,
                      valid_dataset,
                      test_dataset)
    ...
    trainer = Trainer(max_nb_epochs=hypers['max_epochs'],
